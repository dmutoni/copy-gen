        ...
        <View style={styles.container}>
            ...
            <View style={styles.body}>
                ...
                <View style={styles.detailsContainer}>
                    ...
                    />
                    <View>
                        <Text style={styles.names}>Chance Gloria</Text>
                        <Text style={styles.email}>chance.gloria@copygen.com</Text>
                    </View>
                </View>
                ...
                <View style={styles.detailsContainer}>
                    ...
                    />
                    <View>
                        <Text style={styles.names}>Paul Gucci</Text>
                        <Text style={styles.email}>paul.gucci@copygen.com</Text>
                    </View>
                </View>
                ...
                <View style={styles.detailsContainer}>
                    ...
                    />
                    <View>
                        <Text style={styles.names}>Blessing Hirwa</Text>
                        <Text style={styles.email}>blessing.hirwa@copygen.com</Text>
                    </View>
                </View>
                ...
                <View style={styles.detailsContainer}>
                    ...
                    />
                    <View>
                        <Text style={styles.names}>Gersh Lento</Text>
                        <Text style={styles.email}>gersh.lento@copygen.com</Text>
                    </View>
                </View>
                <View style={styles.detailsContainer}>
                    <Image
                ...
                <View style={styles.buttonContainer}>
                    ...
                    <Button style={styles.primaryButton} title="Add client + " onPress={() => navigation.navigate('OrderStatusScreen')}/>
                </View>
            </View>
        </View>
    )
